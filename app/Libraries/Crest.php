...
/*define('C_REST_WEB_HOOK_URL','https://smmrucom.bitrix24.ru/rest/7226/111pdmhtckvosdhq/');//url on creat Webhook
...
class Crest
{
	...
	{
		if(!empty(static::C_REST_WEB_HOOK_URL))
		{
			$arData = [
